...
class DiplomaPdfController extends AlphaPDFController
{
    ...
    function FooterDiploma($tournamentDate)
    {
        ...
        //TOURNAMENT SITE
        $this->Image(BaseController::TOURNAMENT_WEBSITE_URL . '/uploads/sponsors/ca64ecbb4276c8583d9eac5b142c5062839663cf_groot.gif',150,130,0,15);
    ...
    function Wedstrijdnummer($turnster)
    {
        ...
        //IMAGES
        $this->Image(BaseController::TOURNAMENT_WEBSITE_URL . '/uploads/sponsors/9db8eb6e16a55cf34fd6ccb6edd3ce76dac79747_groot.png',22,114,0,30);
        $this->Image(BaseController::TOURNAMENT_WEBSITE_URL . '/uploads/sponsors/9fc2ed362cf8b06300477066fe8c675f15c0ea19_groot.jpg',150,127,0,14);
    }
